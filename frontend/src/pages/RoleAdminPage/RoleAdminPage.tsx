...
import styles from "./RoleAdminPage.module.css";
                ...
                </GridRow>
                {
                    roles ? (
                        roles.content.map((role: RoleDto) => (
                            <GridRow className={styles.role} key={role.id}>
                                <div className={styles.field}>
                                    <span className={styles.fieldHeader}>Название</span>
                                    <span>{role.name}</span>
                                </div>
                                <div className={styles.field}>
                                    <span className={styles.fieldHeader}>Описание</span>
                                    <span className={styles.fieldValue}>{role.description.substring(0, 100)}</span>
                                </div>
                                <div className={styles.field}>
                                    <span className={styles.fieldHeader}>Имя ресурса</span>
                                    <span>{role.resource}</span>

                                </div>
                                <div className={styles.field}>
                                    <span className={styles.fieldHeader}>Дата создания</span>
